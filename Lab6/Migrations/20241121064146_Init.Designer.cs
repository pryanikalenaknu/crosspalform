            ...
            modelBuilder.Entity("Lab6.Data.Entities.CustomerOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 11, 11, 6, 41, 46, 40, DateTimeKind.Utc).AddTicks(6260),
                        ...
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 11, 16, 6, 41, 46, 40, DateTimeKind.Utc).AddTicks(6260),
                            OrderDetails = "Details",
                            OrderStatusCode = 1,
                            PaymentMethodCode = 1
                        },
                        new
                        {
                            OrderId = 3,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 11, 19, 6, 41, 46, 40, DateTimeKind.Utc).AddTicks(6270),
                            OrderDetails = "Details",
                            OrderStatusCode = 2,
                            PaymentMethodCode = 1
                        });
